...
export default {
  command: ['sticker', 's'],
  category: 'stickers',
  description: 'Convertir una imagen o video a sticker.',
  run: async ({ msg, sock, args, usedPrefix, command, text }) => {
    try {
      ...
      let texto1 = meta1 ? meta1 : `EverlightWa`;
